...
const VenueCard = ({ venue, onEdit, onDelete }: Props) => {
  ...
  return (
    <div className="rounded-lg bg-white w-full max-w-80 shadow hover:shadow-lg overflow-hidden flex flex-col cursor-pointer">
      {/* Image */}
      ...
      <div className="p-4 flex-1 flex flex-col" onClick={handleClick}>
        <h2 className="text-lg font-semibold mb-1 flex flex-nowrap line-clamp-3">{venue.name}</h2>
